                ...
                <div class="mb-3">
                    ...
                    <div class="tab-content" id="titleTabContent">
                        <div class="tab-pane fade show active" id="en_title" role="tabpanel" aria-labelledby="english-title-tab">
                            <input type="text" class="form-control" id="en_title_input" name="en_title" placeholder="@lang('base.forum_create.title_post_placeholder')"  value="{{ $post->en_title }}" >
                        </div>
                        <div class="tab-pane fade" id="fr_title" role="tabpanel" aria-labelledby="french-title-tab">
                            <input type="text" class="form-control" id="fr_title_input" name="fr_title" placeholder="@lang('base.forum_create.title_post_placeholder')" value="{{ $post->fr_title }}" >
                        </div>
                    </div>
                </div>
                 <!-- <///  titre en/fr -->
                ...
                <div class="mb-3">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="english" role="tabpanel" aria-labelledby="english-tab">
                            <textarea class="form-control" id="en_content" name="en_content" rows="8" placeholder="@lang('base.forum_create.content_post_placeholder')" value="{{ $post->en_content }}"  ></textarea>
                        </div>
                        <div class="tab-pane fade" id="french" role="tabpanel" aria-labelledby="french-tab">
                            <textarea class="form-control" id="fr_content" name="fr_content" rows="8" placeholder="@lang('base.forum_create.content_post_placeholder')" value="{{ $post->fr_content }}" ></textarea>
                        </div>
                    </div>
                </div>
       <!-- <///  contenue en/fr -->
...
<!-- conteneu fr/en -->
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="french" role="tabpanel" aria-labelledby="french-tab">
            <textarea class="form-control" id="fr_content" name="fr_content" rows="8" placeholder="@lang('base.forum_create.content_post_placeholder')" value="{{ $post->en_content}}" ></textarea>
        </div>
        <div class="tab-pane fade" id="english" role="tabpanel" aria-labelledby="english-tab">
            <textarea class="form-control" id="en_content" name="en_content" rows="8" placeholder="@lang('base.forum_create.content_post_placeholder')" value="{{ $post->fr_content}}" ></textarea>
        </div>
    </div>
</div>
<!--<< //// conteneu fr/en -->
